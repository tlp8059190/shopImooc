...
<div class="headerBar">
    <div class="topBar">
        <div class="comWidth">
            ...
            <div class="rightArea">
                欢迎来到慕课网！
                <?php if(isset($_SESSION['loginFlag']) && !empty($_SESSION['loginFlag'])):?>
...
//                        echo "<br/>*****<br/>";
                        ...
                        <div class="shop_item">
                            <div class="shop_img">
                                <a href="proDetails.php?id=<?php echo $pro['id'];?>" target="_blank"><img height="200" width="187" src="admin/image_350/<?php echo $proImg['albumPath'];?>" alt=""></a>
                            </div>
...
//                print_r($prosSmall);
//                echo "<br/>&&&&&&&&<br/>";
                if(isset($prosSmall) &&  is_array($prosSmall) && !empty($prosSmall)):
//                    echo "<br/>111<br/>";
...
//                      echo "<br/>222<br/>";
                        ...
                        <div class="shopItem_sm">
                            <div class="shopItem_smImg">
                                <a href="proDetails.php?id=<?php echo $proSmall['id'];?>" target="_blank"><img width="95" height="95" src="admin/image_50/<?php echo $proSmallImg['albumPath'];?>" alt=""></a>
                            </div>
